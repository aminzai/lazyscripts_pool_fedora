...
case $PLAT_NAME in
	...
	;;
	"x86_64")
		$WGET 'http://eclipse.stu.edu.tw/technology/epp/downloads/release/ganymede/SR2/eclipse-jee-ganymede-SR2-linux-gtk-x86_64.tar.gz'
	;;
	*)
		echo "Sorry, Lazyscripts not support $DISRIB_ID"
	;;
esac
